...
function createPropertyCards() {
    ...
    properties.forEach((property, index) => {
        ...
        const targetPage = `insidePlantation${index + 1}.html`;
        ...
        propertyCard.innerHTML = `
            ...
            <div class="property-details">
                ...
                <div class="property-info">
                    <div class="info-row">
                        <span class="info-label">Plantation type:</span>
                        <span class="info-value">${property.plantation_Type}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Land Area:</span>
                        <span class="info-value">${property.LandArea}</span>
                    </div>
                    <div class="info-row">
