...
function createPropertyCards() {
    ...
    properties.forEach((property, index) => {
        ...
        const targetPage = `insideHouse${index + 1}.html`;
        ...
        propertyCard.innerHTML = `
            ...
            <div class="property-details">
                ...
                <div class="property-info">
                    <div class="info-row">
                        <span class="info-label">Development type:</span>
                        <span class="info-value">${property.developmentType}</span>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        <span class="info-label">Unit mix:</span>
                        <span class="info-value">${property.unitMix}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Developer:</span>
                        <span class="info-value">${property.developer}</span>
                    </div>
                </div>
